...
public class Controller {
    ...
    @GetMapping("/chain")
    public String chain(@RequestParam(value = "name", defaultValue = "World") String name, @RequestHeader Map<String, String> headers) throws InterruptedException, IOException {
